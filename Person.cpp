...
void Person::set_language(string languages) {};
void Person::set_finished(string finished) {};
void Person::set_projects_current(string currentProjects) {};
...
// Finances functions
void Person::check_turnover_profit(int turnoverMonth, int profitMonth){};
        
 
void Person::set_turnover(int turnoverMonth){};
void Person::set_profit(int profitMonth){};
void Person::set_budget(int Budget){};
void Person::set_expense(int Expense){};
...
void Person::set_bankAccount(int bank_num) {};

string Person::get_bank() {return "";};
void Person::set_bank(string BANK) {};
...
void Person::set_notes(string new_note) {};


//Design functions
string Person::get_design_current() {return "";};
void Person::set_design_current(string design_current) {};

//Sales functions
float Person::get_conversion_rate() {return 0;};
void Person::set_conversion_rate(float con_rate) {};

int Person::get_cars_sold() {return 0;};
void Person::add_cars_sold(int sales) {};

float Person::get_revenue() {return 0;};
void Person::add_revenue(float rev) {};
...
void Person::set_research(string current) {};

string Person::get_expertise() {return "";};
void Person::add_expertise(string expert) {};

//Marketing functions
float Person::get_success_rate() {return 0;};
void Person::set_success_rate(float success) {};

//HumanResources
int Person::get_trained() {return 0;};
void Person::add_trained(int trained) {};

int Person::get_hired() {return 0;};
void Person::add_hired(int hired) {};

int Person::get_fired() {return 0;};
void Person::add_fired(int fired) {};

int Person::get_retired() {return 0;};
void Person::add_retired(int retired) {};

//Manufactoring
string Person::get_certification(){ return "";};
void Person::add_certification(string certification) {};
int Person::get_cars_complete(){return 0;};
void Person::add_cars_complete(int cars_complete) {};

//VIP
string Person::get_VIP_type(){ return "";};
void Person::set_VIP_type(string VIP_type) {};

int Person::get_referrals(){return 0;};
void Person::set_referrals(int referals){};

void Person::displayPrizes(){};
bool Person::buy_prize(string prizeName){};

//Supplier
int Person::get_amount_of_cargo() {return 0;};
string* Person::get_cargo() {string cargo[0]; return cargo;};
float Person::get_cost_annually() {return 0;};

void Person::set_amount_of_cargo(int amountCargo) {};
void Person::set_cargo(string* cargo, int amount) {};
void Person::set_cost_annually(float costAnnually) {};

//Employee functions
int Person::get_ID() {return 0;};

bool Person::get_attendance(int day) {return true;};
void Person::set_attendance(bool attending, int day) {};

int Person::get_performance() {return 0;};
void Person::set_performance(int performance) {};

string Person::get_date_joined() {return "";};

float Person::get_salary_hourly() {return 0;};
void Person::set_salary_hourly(float salary_hourly) {};

float Person::get_hours_weekly() {return 0;};
void Person::set_hours_weekly(float hours_weekly) {};

//Investor
float Person::get_amount_of_investment(){ return 0;};
void Person::set_amount_of_investment(float amount){};
