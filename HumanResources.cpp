...
HumanResources::HumanResources()
    : Employee(), position(""), no_trained(0), no_hired(0), no_fired(0), no_retired(0) {}
HumanResources::HumanResources(string position, int ID, float salary_hourly, float hours_weekly, 
