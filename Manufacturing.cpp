...
Manufacturing::Manufacturing(int ID, float salary_hourly, float hours_weekly, string date_joined, int age, int phone, string name, string address, string position, string certification, int cars_complete)
: Employee(ID, salary_hourly, hours_weekly, date_joined, age, phone, name, address), position("none"), certification("none"), cars_complete(0) {};
