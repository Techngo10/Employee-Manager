...
Design::Design() : Employee(), position("none"), amount_design_finished(""), design_current("none") {}
...
: Employee(salary_hourly, hours_weekly, date_joined, age, phone, name, address), position("none"), amount_design_finished(""), design_current("none") {}

string Design::get_position(){return position;};
void Design::set_position(string position){this->position = position;};

string Design::get_finished(){return amount_design_finished;};
void Design::set_finished(string amount_design_finished){this->amount_design_finished = amount_design_finished;};
